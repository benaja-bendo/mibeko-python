...
class IngestionProvenance(Base):
    ...
    jo_numero = Column(String(255), nullable=True)
    jo_date = Column(Date, nullable=True)
    jo_annee = Column(Integer, nullable=True)
    titre = Column(Text, nullable=True)
    sha256 = Column(String(64), nullable=False)
    fetched_at = Column(DateTime, nullable=True)
    retroactif = Column(Boolean, nullable=False, default=False)
    variantes_multiples = Column(JSONB, nullable=True)
